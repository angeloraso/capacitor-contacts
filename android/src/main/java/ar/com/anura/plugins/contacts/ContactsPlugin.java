...
public class ContactsPlugin extends Plugin {
  ...
  public void getGroups(PluginCall call) throws IOException {
    ...
    GroupSettings settings = getGroupSettings(call);

    JSONArray result = contacts.getGroups(settings);
    JSObject res = new JSObject();
    res.put("contacts", result);
    call.resolve(res);
  }
  ...
  private GroupSettings getGroupSettings(PluginCall call) {
    boolean title = Boolean.TRUE.equals(call.getBoolean("title"));
    boolean systemId = Boolean.TRUE.equals(call.getBoolean("systemId"));
    boolean notes = Boolean.TRUE.equals(call.getBoolean("notes"));
    boolean accountType = Boolean.TRUE.equals(call.getBoolean("accountType"));
    boolean accountName = Boolean.TRUE.equals(call.getBoolean("accountName"));

    return new GroupSettings.Builder()
      .title(title)
      .systemId(systemId)
      .notes(notes)
